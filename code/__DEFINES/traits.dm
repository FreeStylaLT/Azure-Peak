...
#define TRAIT_ACTIVE_SQUIRE "Squire In Active Service"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_ACTIVE_SQUIRE = span_info("I know how to best repair all sorts of gear, preserving their max integrity."),
